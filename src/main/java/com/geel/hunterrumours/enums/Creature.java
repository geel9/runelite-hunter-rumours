...
public enum Creature {
    ...
    WILD_KEBBIT(NpcID.WILD_KEBBIT, ItemID.KEBBIT_9962, DEADFALL, 23, new int[]{102,103}),
    ...
    BARB_TAILED_KEBBIT(NpcID.BARBTAILED_KEBBIT, ItemID.KEBBIT_9958, DEADFALL, 33, new int[]{134,135}),
    ...
    SABRE_TOOTHED_KEBBIT(NpcID.SABRETOOTHED_KEBBIT, ItemID.KEBBIT_9959, DEADFALL, 51, new int[]{160}),
    ...
    PYRE_FOX(NpcID.PYRE_FOX, ItemID.PYRE_FOX, DEADFALL, 57, new int[]{177,178}),
    RED_SALAMANDER(NpcID.RED_SALAMANDER, ItemID.RED_SALAMANDER, NET_TRAP, 59, new int[]{272}),
    WYRMSCRAIG_GOAT(NpcID.WYRMSCRAIG_GOAT, ItemID.WYRMSCRAIG_GOAT_FUR, GOAT_PIT, 60, IntStream.rangeClosed(100, 179).toArray()),
