...
public class HunterRumoursPlugin extends Plugin {
    ...
    private void loadFromConfig() {
        ...
        if (loadedCurrentHunter == null) loadedCurrentHunter = Hunter.NONE;
        ...
        for (var hunter : Hunter.allValues()) {
            ...
            if (rumour == null) rumour = Rumour.NONE;
        ...
        if (loadedDetachedRumour == null) loadedDetachedRumour = Rumour.NONE;
